class Cmvp < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/ethanolivertroy/cmvp-tui/releases/download/v0.1.0/cmvp-darwin-arm64"
      sha256 "9b0590491a7465ba54d5d88e917ee74bef358583a170d21e2985c77e71a3220b"
    else
      url "https://github.com/ethanolivertroy/cmvp-tui/releases/download/v0.1.0/cmvp-darwin-amd64"
  ...
  on_linux do
    if Hardware::CPU.arm?
      url "https://github.com/ethanolivertroy/cmvp-tui/releases/download/v0.1.0/cmvp-linux-arm64"
      sha256 "2df76c58e6f70b5d4a82595f630cc5401dd24918077d262850b95649f0fdc556"
    else
      url "https://github.com/ethanolivertroy/cmvp-tui/releases/download/v0.1.0/cmvp-linux-amd64"
